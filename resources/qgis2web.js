...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1383094.719055, 7481773.783623, 1395452.297419, 7490368.500754], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [1382994.392704, 7478759.230765, 1392518.394576, 7492395.148019],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([1383094.719055, 7481773.783623, 1395452.297419, 7490368.500754], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_bindnger_lokalplaner_4,
    colName: 'plannr',
    zoom: 10,
    collapsed: true,
    map: map,
